        ...
        <div class="row listing-results">
          <div class="results-count">
            <span class="counter">
				...
				$type = $_GET['type'];
			 $sql ="SELECT * 
FROM  `brands` WHERE `Type` Like '%$type%' ";
}
else if(isset($_POST['search'])) {
$word = $_POST['search'];
$sql ="SELECT * 
FROM  `brands` WHERE `Name` Like '%$word%' OR `City` Like '%$word%' OR `Country` Like '%$word%' OR `Type` Like '%$word%'";
}
else {
$sql ="SELECT * 
FROM  `brands`";
            ...
            <div class="col-sm-4">
              <div class="listing-item">
                <a href="brand_profile.php?b_id= <?php echo $id; ?>" class="listing-item-link">
                  ...
                  <img alt=""  style="width:250px;height:250px" src="../Brands/BrandPics/<?php echo $row['Cover']; ?>" />
                </a>
