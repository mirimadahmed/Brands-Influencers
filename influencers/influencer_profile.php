      ...
      <div class="container listing-description" id="desc">
        ...
        <div class="row">
          <div class="col-sm-3 text-center">
			...
			<a href="../chat/influencer_mailbox.php">
			<div class="ribbon">
			  Messages</div> </a><?php } ?>
...
?>
			...
			$f_review ="Good"; ?>
			  ...
			  <?php } ?>
			   <?php if($excellent==0 && $good==0 && $regular==0 && $notgood==0 && $bad==0) {
			  $f_review =""; ?>
	...
	<?php		  $s = "SELECT * FROM  `influencerreviews` WHERE  `influencerID` ='$id'";
            ...
            <div class="row author-block">
              <div class="col-sm-12 text-left">
                <a href="#" class="author-avatar pull-left" style="background-image: url(../Brands/BrandPics/<?php echo $res['Cover']; ?>)">
                </a>
