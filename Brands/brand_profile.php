  ...
  <body>
    ...
    <div class="body-wrapper">
	 ...
	 ?>
      ...
      <div class="container-fluid pg-header" style="background-image: url(BrandPics/<?php echo $cover;?>);">
        ...
        <div class="row">
          ...
          <div class="col-md-9 text-center">
            <div class="post-content margin-top text-justify">
			  ...
			  <?php } ?>
			   <?php 
	  $sql= "SELECT *  FROM  `brandpics` WHERE  `Brand_id` ='$id'";
	    $query= mysqli_query($con,$sql);
	   $res= mysqli_fetch_array($query);
	$img1 = $res['Img1'];
	$img2 = $res['Img2'];
	if(!empty($img1)) {
	  ?>
              <p>
                <a href="BrandPics/<?php echo $img1; ?>" data-lightbox="gallery">
                  <img alt="" src="BrandPics/<?php echo $img1; ?>" class="pull-left thumbnail" style="width:250px;height:250px"/>
                </a>
 <?php  }
  else {
  ?>
  ...
  echo $desc; ?>
              ...
              <p>
                ...
                <a href="BrandPics/<?php echo $img2;?>" data-lightbox="gallery">
                  <img alt="" src="BrandPics/<?php echo $img2;?>" class="pull-right thumbnail" style="width:250px;height:250px"/>
                </a>
             <?php } 
			 else {
			 }
...
$x = mysqli_fetch_array($z);
				   ...
				   <div class="comment-main-level">
                    <a href="#" class="comment-avatar"><img alt="" src="../influencers/influencerPics/<?php echo $u['logo']; ?>"></a>
                ...
                <div class="widget news-archive"> <!--start widget-->
                  <div class="block">
                    <div class="widget-title">
                      <div class="the-title">
                       <a href="../chat/brand_mailbox.php"><center><i class="fa fa-envelope"></i> <span class="nav-label">Mailbox </span></center></a>
                      </div>
                    </div>
					</div>
					</div>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              <a href="brand_profile.php?b_id=<?php echo $ID; ?>" class="listing-item-link">
                ...
                <img alt="" src="BrandPics/<?php echo $rows['Cover'];?>" style="height:250px;width:250px"/>
              </a>
